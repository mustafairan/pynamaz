...
#
# Created: Mon Jan 18 22:50:07 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_8.addWidget(self.lcdNumberCurrentMinute, 1, 4, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.lcdNumberCurrentHour, 1, 3, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.lcdNumberCurrentSecond, 1, 5, 1, 1)
        ...
        self.gridLayoutWidget_10 = QtGui.QWidget(self.groupBox_4)
        ...
        self.gridLayout_9 = QtGui.QGridLayout(self.gridLayoutWidget_10)
        self.gridLayout_9.setMargin(0)
        self.gridLayout_9.setObjectName(_fromUtf8("gridLayout_9"))
        self.pushButtonWarningsReset = QtGui.QPushButton(self.gridLayoutWidget_10)
        self.pushButtonWarningsReset.setObjectName(_fromUtf8("pushButtonWarningsReset"))
        self.gridLayout_9.addWidget(self.pushButtonWarningsReset, 0, 2, 1, 1)
        self.pushButtonWarningsReturnToDefaults = QtGui.QPushButton(self.gridLayoutWidget_10)
        self.pushButtonWarningsReturnToDefaults.setObjectName(_fromUtf8("pushButtonWarningsReturnToDefaults"))
        self.gridLayout_9.addWidget(self.pushButtonWarningsReturnToDefaults, 0, 1, 1, 1)
        self.pushButtonWarningsSave = QtGui.QPushButton(self.gridLayoutWidget_10)
        self.pushButtonWarningsSave.setObjectName(_fromUtf8("pushButtonWarningsSave"))
        ...
        self.checkBoxSunriseWarn = QtGui.QCheckBox(self.gridLayoutWidget_4)
        self.checkBoxSunriseWarn.setObjectName(_fromUtf8("checkBoxSunriseWarn"))
        self.gridLayout_4.addWidget(self.checkBoxSunriseWarn, 1, 0, 1, 1)
        self.spinBoxSunriseWarn = QtGui.QSpinBox(self.gridLayoutWidget_4)
        self.spinBoxSunriseWarn.setObjectName(_fromUtf8("spinBoxSunriseWarn"))
        ...
        self.comboBoxCloseOption.addItem(_fromUtf8(""))
        self.comboBoxCloseOption.addItem(_fromUtf8(""))
        ...
        self.toolButton_2 = QtGui.QToolButton(self.gridLayoutWidget_5)
        self.toolButton_2.setObjectName(_fromUtf8("toolButton_2"))
        self.gridLayout_6.addWidget(self.toolButton_2, 9, 1, 1, 1)
        self.checkBoxSystemNotifications = QtGui.QCheckBox(self.gridLayoutWidget_5)
        self.checkBoxSystemNotifications.setObjectName(_fromUtf8("checkBoxSystemNotifications"))
        ...
        self.gridLayout_5 = QtGui.QGridLayout(self.gridLayoutWidget_9)
        self.gridLayout_5.setMargin(0)
        self.gridLayout_5.setObjectName(_fromUtf8("gridLayout_5"))
        self.pushButtonPreferencesReset = QtGui.QPushButton(self.gridLayoutWidget_9)
        self.pushButtonPreferencesReset.setObjectName(_fromUtf8("pushButtonPreferencesReset"))
        self.gridLayout_5.addWidget(self.pushButtonPreferencesReset, 0, 2, 1, 1)
        self.pushButtonPreferencesSave = QtGui.QPushButton(self.gridLayoutWidget_9)
        self.pushButtonPreferencesSave.setObjectName(_fromUtf8("pushButtonPreferencesSave"))
        self.gridLayout_5.addWidget(self.pushButtonPreferencesSave, 0, 0, 1, 1)
        self.pushButtonPreferencesReturnToDefaults = QtGui.QPushButton(self.gridLayoutWidget_9)
        self.pushButtonPreferencesReturnToDefaults.setObjectName(_fromUtf8("pushButtonPreferencesReturnToDefaults"))
        ...
        self.gridLayout_17 = QtGui.QGridLayout(self.gridLayoutWidget_8)
        ...
        self.pushButton_4 = QtGui.QPushButton(self.gridLayoutWidget_8)
        ...
        self.menuGizle = QtGui.QMenu(self.menuMen)
        self.menuGizle.setObjectName(_fromUtf8("menuGizle"))
        self.menuNas_l_kullan_l_r = QtGui.QMenu(self.menubar)
        self.menuNas_l_kullan_l_r.setObjectName(_fromUtf8("menuNas_l_kullan_l_r"))
        ...
        self.actionGetthehellout = QtGui.QAction(MainWindow)
        self.actionGetthehellout.setObjectName(_fromUtf8("actionGetthehellout"))
        self.actionNas_l_kullan_l_r = QtGui.QAction(MainWindow)
        self.actionNas_l_kullan_l_r.setObjectName(_fromUtf8("actionNas_l_kullan_l_r"))
        ...
        self.menuMen.addAction(self.menuGizle.menuAction())
        ...
        QtCore.QObject.connect(self.testbutton, QtCore.SIGNAL(_fromUtf8("clicked()")), self.actionGetthehellout.hover)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonWarningsReset.setText(_translate("MainWindow", "Reset", None))
        self.pushButtonWarningsReturnToDefaults.setText(_translate("MainWindow", "Varsayılana Dön", None))
        self.pushButtonWarningsSave.setText(_translate("MainWindow", "Kaydet", None))
        ...
        self.checkBoxSunriseWarn.setText(_translate("MainWindow", "Güneş", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "Uyarılar", None))
        self.groupBox.setTitle(_translate("MainWindow", "Seçenekler", None))
        ...
        self.comboBoxCloseOption.setItemText(0, _translate("MainWindow", "Tamamen kapat", None))
        self.comboBoxCloseOption.setItemText(1, _translate("MainWindow", "Gizle", None))
        self.toolButton.setText(_translate("MainWindow", "...", None))
        self.toolButton_2.setText(_translate("MainWindow", "...", None))
        self.checkBoxSystemNotifications.setText(_translate("MainWindow", "Sistem bildirimleri açık", None))
        self.pushButtonPreferencesReset.setText(_translate("MainWindow", "Reset", None))
        self.pushButtonPreferencesSave.setText(_translate("MainWindow", "Kaydet", None))
        self.pushButtonPreferencesReturnToDefaults.setText(_translate("MainWindow", "Varsayılana Dön", None))
        ...
        self.label_41.setText(_translate("MainWindow", "Vakit Bağlantısı", None))
        self.pushButton_3.setText(_translate("MainWindow", "github.com/mustafairan/pynamaz", None))
        self.pushButton_4.setText(_translate("MainWindow", "diyanet.gov.tr/tr/PrayerTime/WorldPrayerTimes", None))
        self.pushButton.setText(_translate("MainWindow", "www.diyanet.gov.tr", None))
        self.label_42.setText(_translate("MainWindow", "Geliştirici Sayfası", None))
        self.label_43.setText(_translate("MainWindow", "Uygulama Deposu", None))
        self.label_44.setText(_translate("MainWindow", "Diyanet.gov.tr", None))
        ...
        self.menuGizle.setTitle(_translate("MainWindow", "Gizle", None))
        self.menuNas_l_kullan_l_r.setTitle(_translate("MainWindow", "Nasıl kullanılır?", None))
        ...
        self.actionGetthehellout.setText(_translate("MainWindow", "getthehellout", None))
        self.actionNas_l_kullan_l_r.setText(_translate("MainWindow", "Kullanımı Anlat", None))

# -*- coding: utf-8 -*-

# Form implementation generated from reading ui file 'ui_pynamaz.ui'
#
# Created: Mon Jan 18 22:52:51 2016
#      by: PyQt4 UI code generator 4.11.2
#
# WARNING! All changes made in this file will be lost!
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_8.addWidget(self.labelCurrentDate, 1, 1, 1, 1)
        self.labelCurrentCity = QtGui.QLabel(self.gridLayoutWidget_7)
        self.labelCurrentCity.setText(_fromUtf8(""))
        self.labelCurrentCity.setObjectName(_fromUtf8("labelCurrentCity"))
        self.gridLayout_8.addWidget(self.labelCurrentCity, 1, 0, 1, 1)
        self.lcdNumberCurrentMinute = QtGui.QLCDNumber(self.gridLayoutWidget_7)
        self.lcdNumberCurrentMinute.setFrameShape(QtGui.QFrame.StyledPanel)
...
# Form implementation generated from reading ui file 'ui_pynamaz.ui'
#
# Created: Mon Jan 18 22:58:59 2016
#      by: PyQt4 UI code generator 4.11.2
#
# WARNING! All changes made in this file will be lost!
...
# Form implementation generated from reading ui file 'ui_pynamaz.ui'
#
# Created: Mon Jan 18 22:59:59 2016
#      by: PyQt4 UI code generator 4.11.2
#
# WARNING! All changes made in this file will be lost!
